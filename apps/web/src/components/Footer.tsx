    ...
    <footer className="border-t border-gray-800 bg-gray-950 mt-auto">
      <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
        <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 text-center sm:text-left">
          <span className="font-semibold text-gray-400">AI Image Insight</span>
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-gray-300 transition-colors flex items-center gap-1.5">
        ...
        <p className="text-xs text-gray-600">© {new Date().getFullYear()} AI Image Insight</p>
      </div>
    </footer>
  );
}
